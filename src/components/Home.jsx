...
function Home({ collections, onSaveToCollection }) {
  ...
  const isMovieInCollection = (imdbID) => {
    return collections.some(movie => movie.imdbID === imdbID);
  };

  return (
    <div className="container mt-5 justify-content-center d-flex flex-column" style={{ minHeight: '80vh' }}>
            ...
            <div key={movie.imdbID} className="col-md-3 mb-3 d-flex justify-content-center">
              <div style={{ minWidth: '250px', maxWidth: '280px', width: '100%' }}>
                <MovieCard
                  ...
                  poster={movie.Poster}
                  imdbID={movie.imdbID}
                  isInCollection={isMovieInCollection(movie.imdbID)}
